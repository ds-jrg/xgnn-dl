...
list_datasets = ['house', 'circle5']
dict_types_to_classify = {'house': 'B', 'circle5': 'A'}
gnn_parameters = [{'name': 'SAGE_2_20', 'gnn_layers': 2, 'epochs': 20},
                  ]
...
for ds in list_datasets:
    for gnnparams in gnn_parameters:
        ...
        # return top CEs
        test_ce_dataset = create_test_dataset(dataset=ds, num_nodes=100)
